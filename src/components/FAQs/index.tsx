			...
			<Accordion allowMultiple margin={'0 auto'} style={{ width: '100%', maxWidth: '600px' }}>
				...
				<AccordionItem>
					<h2>
						<AccordionButton>
							<Box flex="1" textAlign="left">
								Does InnovaRise take any fees?
							</Box>
							<AccordionIcon />
						</AccordionButton>
					</h2>
					<AccordionPanel pb={4}>
						InnovaRise takes 0 fee on swaps.
						<br />
						<br /> You'll get the exact same price swapping through InnovaRise as what you'd get swapping through the
						...
						of it is shared with InnovaRise. We also integrate aggregators with no fee sharing the best price, and in
				...
				<AccordionItem>
					<h2>
						<AccordionButton>
							<Box flex="1" textAlign="left">
								Will I be eligible for aggregator airdrops if I swap through InnovaRise?
							</Box>
							<AccordionIcon />
						</AccordionButton>
					</h2>
					<AccordionPanel pb={4}>
						...
						executed directly from their UI and a swap executed from InnovaRise.
						<br />
						<br />
